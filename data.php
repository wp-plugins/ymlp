...
class GFYMLPData{
    ...
    public static function update_table(){
        global $wpdb;
        $table_name = self::get_ymlp_table_name();
    ...
    public static function get_ymlp_table_name(){
        global $wpdb;
        return $wpdb->prefix . "rg_ymlp";
    }
    ...
    public static function drop_tables(){
        global $wpdb;
        $wpdb->query("DROP TABLE IF EXISTS " . self::get_ymlp_table_name());
    }
}
?>
